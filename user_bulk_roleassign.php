...
echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('roleassign', 'tool_userbulkrolechange'));

echo html_writer::span(get_string('roleassigninfo', 'tool_userbulkrolechange', count($SESSION->bulk_users)));
